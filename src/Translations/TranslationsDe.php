...
class TranslationsDe
{
    public const TRANSLATIONS = [
        ...
        'drag_images_to_upload' => 'Ziehen Sie Bilder zum Hochladen hierher',
        ...
        'limited_to_1_image' => 'Dieses Feld ist auf 1 Bild begrenzt',
        'limited_to_x_images' => 'Dieses Feld ist auf {{qty}} Bilder begrenzt',
