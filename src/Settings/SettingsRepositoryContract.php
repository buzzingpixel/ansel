...
interface SettingsRepositoryContract
{
    ...
    public const CRAFT_KEYS   = [
        ...
        'default_show_title' => 'defaultShowTitle',
        'default_require_title' => 'defaultRequireTitle',
        'default_title_label' => 'defaultTitleLabel',
        'default_show_caption' => 'defaultShowCaption',
        'default_require_caption' => 'defaultRequireCaption',
        'default_caption_label' => 'defaultCaptionLabel',
        'default_show_cover' => 'defaultShowCover',
        'default_require_cover' => 'defaultRequireCover',
        'default_cover_label' => 'defaultCoverLabel',
