...
const RenderImage = ({ image }: { image: ImageType }) => <li className="todo--ansel-field-working ansel_col-span-1 ansel_flex ansel_flex-col ansel_text-center ansel_bg-white ansel_rounded-lg ansel_shadow ansel_divide-y ansel_divide-gray-200">
    ...
    <div>
        <div className="ansel_-mt-px ansel_flex ansel_border-0 ansel_border-t ansel_border-gray-200 ansel_border-solid">
            ...
            <DeleteButton id={String(image.id).toString()} />
        </div>
    </div>
</li>;
