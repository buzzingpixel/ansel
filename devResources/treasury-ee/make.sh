...
name=($(jq -r '.name' treasury/addon.json));

# Get the software version
version=($(jq -r '.version' treasury/addon.json));
...
cp -r treasury localStorage/build/system/user/addons/treasury;
cp -r treasury_themes localStorage/build/themes/user/treasury;
cp -r treasury/license.md localStorage/build/license.md;
cp -r treasury/copyright.md localStorage/build/copyright.md;
